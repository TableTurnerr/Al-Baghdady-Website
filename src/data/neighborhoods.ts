export type Neighborhood = {
  ...
  /** Real local landmarks/areas, used to compose genuinely city-specific delivery copy on the mesh. */
  landmarks?: string[];
};
...
export const NEIGHBORHOODS: Neighborhood[] = [
  {
    ...
    landmarks: ["Legacy West", "The Shops at Legacy", "Downtown Plano", "Granite Park"],
  },
  {
    slug: "garland-tx",
    city: "Garland",
    ...
    landmarks: ["Downtown Garland", "Firewheel Town Center", "Lake Ray Hubbard"],
  },
  {
    slug: "addison-tx",
    city: "Addison",
    ...
    landmarks: ["Addison Circle", "Belt Line Road", "the Dallas North Tollway corridor"],
  },
  {
    ...
    landmarks: ["the Galleria", "Preston Hollow", "the Dallas North Tollway"],
  },
  {
    slug: "allen-tx",
    city: "Allen",
    ...
    landmarks: ["Watters Creek", "The Village at Allen", "Allen Premium Outlets"],
  },
  {
    slug: "mckinney-tx",
    city: "McKinney",
    ...
    landmarks: ["Historic Downtown McKinney", "Craig Ranch", "Stonebridge Ranch"],
  },
  {
    ...
    landmarks: ["the Galleria area", "Prestonwood", "the Tollway and Belt Line corridor"],
  },
  {
    slug: "irving-tx",
    city: "Irving",
    ...
    landmarks: ["Las Colinas", "the Toyota Music Factory", "the Irving Arts District"],
  },
  {
    slug: "carrollton-tx",
    city: "Carrollton",
    ...
    popularDishes: ["Baklava", "Kanafa", "Fatayer", "Mabrouma"],
    landmarks: ["Downtown Carrollton", "Trinity Mills", "the Old Downtown Square"],
  },
  {
    slug: "frisco-tx",
    city: "Frisco",
    ...
    landmarks: ["The Star", "Stonebriar Centre", "Frisco Square"],
  },
  {
    slug: "coppell-tx",
    city: "Coppell",
    ...
    landmarks: ["Old Town Coppell", "Cypress Waters", "the MacArthur corridor"],
  },
  {
    slug: "euless-tx",
    city: "Euless",
    ...
    landmarks: ["the Mid-Cities", "Glade Parks", "Midway Park"],
  },
  {
    slug: "dallas-tx",
    city: "Dallas",
    ...
    landmarks: ["Uptown", "Downtown Dallas", "the Arts District", "Deep Ellum"],
  },
];
