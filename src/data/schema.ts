...
const KNOWS_ABOUT = [
  ...
  "Iraqi breakfast",
  "Baklava (pistachio, walnut, mixed, bread baklava)",
  "Kunafa (kanafa)",
  "Samoon bread",
  "Tandoor bread",
  "Tashreeb",
...
export function menuSchema() {
  return {
    ...
    description:
      "Authentic Iraqi bakery and breakfast café menu: baklava, kunafa, ladyfingers, samoon, fatayer, manakish, awama, mabrouma, leblebi, kibbeh, traditional Iraqi breakfast dishes, kabob platters, and karak chai.",
    inLanguage: "en-US",
