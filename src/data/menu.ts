  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Classic Iraqi-style round bread, baked fresh daily.",
        price: "$3.99",
      },
      {
        name: "Bread (1 pc)",
        description: "Single piece of freshly baked bread.",
        price: "$1.99",
      },
      {
        name: "Samoon (1 pc)",
        description: "Single piece of our signature Iraqi samoon bread.",
        price: "$1.25",
      },
    ],
  },
