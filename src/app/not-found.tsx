...
export const metadata: Metadata = createMetadata({
  title: "Page Not Found (404) | Al-Baghdady Bakery & Café",
  description:
    "This page is off the menu. Find your way back to our authentic Iraqi bakery, café and catering — or give us a call.",
  path: "/404/",
  noindex: true,
});
...
const QUICK_LINKS = [
  {
    href: "/menu/",
    title: "The Menu",
    body: "Iraqi sweets, daily breakfast, fresh bakery and savory plates.",
    icon: UtensilsCrossed,
  },
  {
    href: "/our-story/",
    title: "Our Story",
    body: "From Baghdad in 1919 to Richardson — four generations of baking.",
    icon: BookOpen,
  },
  {
    href: "/catering/",
    title: "Catering",
    body: "Full-service Iraqi catering for events large and small.",
    icon: Soup,
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-warm-white)] min-h-screen">
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(201,168,76,0.40), transparent 70%)",
        }}
      />
      <div
        aria-hidden="true"
      ...
      <div className="container-pad relative pt-16 md:pt-24 pb-10 md:pb-14 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg text-[var(--color-text-muted)] leading-relaxed">
          The page you&apos;re looking for slipped between the trays. The link
          may be old, or the recipe may have moved — but the bread is still
          warm, and you&apos;re always welcome at our table.
        </p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          ...
          <ThemeBtn href="/menu/" variant="secondary">
            View Menu
          </ThemeBtn>
        </div>
